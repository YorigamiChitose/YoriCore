...
object RV32I {
  ...
  val table = Array(
    ...
    INST.SLLI  -> List(rs1.EN, rs2.NOP, rd.EN, op1.RS1, op2.IMM, alu.SLL, imm.I, branch.NOP, mul.NOP, div.NOP, mem.NOP, csr.NOP, exc.NOP),
    ...
    INST.SRLI  -> List(rs1.EN, rs2.NOP, rd.EN, op1.RS1, op2.IMM, alu.SRL, imm.I, branch.NOP, mul.NOP, div.NOP, mem.NOP, csr.NOP, exc.NOP),
    INST.SRAI  -> List(rs1.EN, rs2.NOP, rd.EN, op1.RS1, op2.IMM, alu.SRA, imm.I, branch.NOP, mul.NOP, div.NOP, mem.NOP, csr.NOP, exc.NOP),
    ...
    // (BRANCH) (rd = (pc + 4, exc.NOP), pc += immJ) (pc = ~1 & (rs1 + immI, exc.NOP), rd = pc + 4)
